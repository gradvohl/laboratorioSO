...
Para registrar qual a função que será chamada para tratar um sinal específico utilizaremos a primitiva \texttt{signal}, cuja sintaxe é a seguinte, de acordo com o manual:
...
\end{lstlisting}
onde o primeiro parâmetro é o sinal que se deseja interceptar, dentre aqueles da \Cref{tab:sinais}. O segundo parâmetro é a função que tratará o sinal interceptado.
