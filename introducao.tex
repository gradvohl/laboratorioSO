...
Todos os comandos que serão utilizados nesse tutorial serão executados no interpretador da linha de comandos (\textit{shell}), também chamado de terminal. Para compilar os programas, utilizaremos o compilador \Comando{gcc}, disponível na maioria das distribuições Linux.
